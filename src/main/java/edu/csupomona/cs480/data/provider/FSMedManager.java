...
//		Medicine InsulinLisproA = new Medicine("Insulin_Lispro", "Humalog", "", "Insulin Rapid Acting", PurposeList);
//		medList.add(InsulinLisproA);
//		PurposeList = new ArrayList<String>(Arrays.asList("Diabetes Type 2","Diabetes Type 2"));
//		Medicine InsulinLisproB = new Medicine("Insulin_Lispro", "Humulin", "", "Insulin Rapid Acting", PurposeList);
...
//		PurposeList = new ArrayList<String>(Arrays.asList("Diabetes Type 2","Diabetes Type 1"));
//		Medicine InsulinDetemir = new Medicine("insulin_Detemir", "Levemir", "", "Insulin Long Acting", PurposeList);
//		medList.add(InsulinDetemir);
//		PurposeList = new ArrayList<String>(Arrays.asList("Diabetes Type 2","Diabetes Type 1"));
//		Medicine InsulinGlargineA = new Medicine("insulin_Glargine", "Lantus", "", "Insulin Long Acting", PurposeList);
...
//		PurposeList = new ArrayList<String>(Arrays.asList("Diabetes Type 2","Diabetes Type 1"));
//		Medicine InsulinAspart = new Medicine("insulin_Aspart", "Novolog", "", "Insulin Rapid Acting", PurposeList);
//		medList.add(InsulinAspart);
//		PurposeList = new ArrayList<String>(Arrays.asList("Diabetes Type 2","Diabetes Type 1"));
//		Medicine InsulinGlargineB = new Medicine("insulin_Glargine", "Toujeo", "", "Insulin Long Acting", PurposeList);
